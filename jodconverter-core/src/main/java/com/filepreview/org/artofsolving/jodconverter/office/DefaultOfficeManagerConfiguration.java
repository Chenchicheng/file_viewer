...
//
package com.filepreview.org.artofsolving.jodconverter.office;

import java.io.File;

import com.filepreview.org.artofsolving.jodconverter.process.LinuxProcessManager;
import com.filepreview.org.artofsolving.jodconverter.process.ProcessManager;
import com.filepreview.org.artofsolving.jodconverter.process.PureJavaProcessManager;
import com.filepreview.org.artofsolving.jodconverter.process.SigarProcessManager;
import com.filepreview.org.artofsolving.jodconverter.util.PlatformUtils;
...
public class DefaultOfficeManagerConfiguration {
    ...
    private boolean isSigarAvailable() {
        try {
            ...
            Object  o = Class.forName("org.hyperic.sigar.Sigar", false, classLoader);
            return true;
